    ...
    if ($category == "" || $title == "" || $published_date == "") {
        ...
        if ($error == "") {
            ...
            $sql = "INSERT INTO blogs
                    (category, title, published_date, image, excerpt, content, read_time, status, is_deleted)
                    VALUES (?, ?, ?, ?, ?, ?, ?, ?, 0)";
...
<div class="blog-form-container">
    ...
    <div class="form-header-bar">
        <div>
            <h1>Add Blog</h1>
            <p>Create and publish a new industry article or company news update.</p>
        </div>
    ...
    <div class="blog-form-card">
        ...
        <form method="POST" enctype="multipart/form-data">
            ...
            <div class="form-grid-row">
                <div class="form-group">
                    <label class="form-label" for="blog-image">Featured Image</label>
                    <input
                        type="file"
                        id="blog-image"
                        name="image"
            ...
            <div class="form-actions-bar">
                <button type="submit" name="add_blog" class="btn-submit-blog">
                    Save Blog
                </button>
